...
from maml_zoo.envs.point_envs.point_env_2d_corner import SparsePointEnv
...
if __name__=="__main__":
    ...
    data_path =  './data/erl2/point-sparse/test_%d' % idx
    logger.configure(dir=data_path, format_strs=['stdout', 'log', 'csv'],
                     snapshot_mode='last_gap')
    config = json.load(open(maml_zoo_path + "/configs/erl2_config_point.json", 'r'))

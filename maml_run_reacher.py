...
from meta_policy_search.envs.mujoco_envs.hopper_rand_params_wrapper import  HopperRandParamsWrappedEnv
from meta_policy_search.envs.mujoco_envs.reacher_goal import  ReacherGoalEnv_sparse
...
if __name__=="__main__":
    ...
    parser.add_argument('--dump_path', type=str, default=meta_policy_search_path + '/data/maml/reacher-goal/run_%d' % idx)

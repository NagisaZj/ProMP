...
from meta_policy_search.envs.mujoco_envs.walker_rand_params_wrapper import  WalkerRandParamsWrappedEnv
...
if __name__=="__main__":
    ...
    data_path =  './data/erl2/walker-params/test_%d' % idx
    logger.configure(dir=data_path, format_strs=['stdout', 'log', 'csv'],
                     snapshot_mode='last_gap')
    config = json.load(open(maml_zoo_path + "/configs/erl2_config_walker_params.json", 'r'))

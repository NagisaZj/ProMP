...
from maml_zoo.envs.mujoco_envs.reacher_goal import ReacherGoalEnv_sparse
...
def main(config):
    ...
    env = rl2env(ReacherGoalEnv_sparse())
...
if __name__=="__main__":
    ...
    data_path =  './data/erl2/reacher-goal/test_%d' % idx
    logger.configure(dir=data_path, format_strs=['stdout', 'log', 'csv'],
                     snapshot_mode='last_gap')
    config = json.load(open(maml_zoo_path + "/configs/erl2_config_reacher.json", 'r'))

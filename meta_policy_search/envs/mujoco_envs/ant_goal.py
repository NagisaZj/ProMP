...
class AntGoalEnv(MultitaskAntEnv):
    def __init__(self, task={}, n_tasks=2, randomize_tasks=True):
        super(AntGoalEnv, self).__init__(task, n_tasks)
...
class AntGoalEnvSparse(MultitaskAntEnv):
    def __init__(self, task={}, n_tasks=2, randomize_tasks=True, goal_radius=0.8):
        self.goal_radius = goal_radius

        super(AntGoalEnvSparse, self).__init__(task, n_tasks)
